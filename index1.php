    ...
    <div class="swiper featured-slider">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide box">
                ...
                <div class="image">
                   <a href="./product.html"> <img src="do it today.jpg" alt=""> </a>
                </div>
                <div class="content">
                    <h3>Do It Today</h3>
                    <div class="price">₹140 <span>₹199</span></div>
            ...
            <div class="swiper-slide box">
                ...
                <div class="image">
                    <a href="./product.html"> <img src="Images\power subconscious mind.png" alt=""> </a>
            </div>
                <div class="content">
                    <h3>Power of Your Subconscious Mind</h3>
                    <div class="price">₹129 <span>₹210</span></div>
                    <a href="./cart.html" class="btn">add to cart</a>
                </div>
            </div>
            ...
            <div class="swiper-slide box">
                ...
                <div class="image">
                    <a href="product.html"><img src="Images\good girl guide to murder.jpg" alt=""> </a>
                </div>
                <div class="content">
                    <h3>A Good Girl's Guide To Murder</h3>
                    <div class="price">₹317 <span>₹350</span></div>
                    <a href="./cart.html" class="btn">add to cart</a>
                </div>
            </div>
            ...
            <div class="swiper-slide box">
                ...
                <div class="content">
                    <h3>Samsara</h3>
                    <div class="price">₹146<span>₹200</span></div>
                    <a href="./cart.html" class="btn">add to cart</a>
                </div>
            </div>
            ...
            <div class="swiper-slide box">
                ...
                <div class="content">
                    ...
                    <div class="price">₹855 <span>₹1000</span></div>
                    <a href="./cart.html" class="btn">add to cart</a>
                </div>
            </div>
            ...
            <div class="swiper-slide box">
                ...
                <div class="content">
                    ...
                    <div class="price">₹220 <span>₹300</span></div>
                    <a href="./cart.html" class="btn">add to cart</a>
                </div>
            </div>
            ...
            <div class="swiper-slide box">
                ...
                <div class="image">
                    <img src="Images\too good to be true.jpg" alt="">
                </div>
                <div class="content">
                    <h3>Too Good To Be True</h3>
                    <div class="price">₹270<span>₹350</span></div>
                    <a href="./cart.html" class="btn">add to cart</a>
                </div>
            </div>
            ...
            <div class="swiper-slide box">
                ...
                <div class="content">
                    ...
                    <div class="price">₹189 <span>₹250</span></div>
                    <a href="./cart.html" class="btn">add to cart</a>
                </div>
            </div>
...
<section class="newsletter">
    ...
    <form action="">
        <h3>Login In</h3>
        <input type="email" name="" placeholder="enter your email/Phone Number" id="" class="box">
        <input type="submit" value="Login" class="btn">
    </form>
